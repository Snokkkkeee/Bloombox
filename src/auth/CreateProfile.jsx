...
import { auth } from '/Users/jwsnooke/Desktop/Bloombox/src/Services/firebase.js';
...
const handleSubmit = async (e) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <input type="text" name="bio" placeholder="Bio" onChange={handleInputChange} />
      ...
      <input type="text" name="season" placeholder="Current Season" onChange={handleInputChange} />
